function openNav() {
  ...
  document.getElementById("mySideNavblur").style.width = "22%";
  document.getElementById("mouseBlur").style.left = "22%";
...
function closeNav() {
  ...
  document.getElementById("mySideNavblur").style.width = "0%";
  document.getElementById("mouseBlur").style.left = "0%";
